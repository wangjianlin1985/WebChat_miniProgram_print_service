...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">小程序打印平台</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>PrintShop/frontlist">打印店查询</a></li>
                <li><a href="<%=basePath %>ProductClass/frontlist">套餐类别</a></li>
                <li><a href="<%=basePath %>Product/frontlist">打印服务</a></li> 
             ...
             <ul class="nav navbar-nav navbar-right">
             	<%
				    ...
				    if(user_name==null){
	  			%> 
	  			<li><a href="<%=basePath %>PrintShop/printShop_frontAdd.jsp"><i class="fa fa-sign-in"></i>&nbsp;&nbsp;打印店注册</a></li>
                <li><a href="#" onclick="login();"><i class="fa fa-user"></i>&nbsp;&nbsp;店长登录</a></li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Product/product_shopFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;打印服务发布</a></li>
                        <li><a href="<%=basePath %>Product/shopFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的服务</a></li> 
                        <li><a href="<%=basePath %>OrderInfo/shopFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的打印订单</a></li>
                        <li><a href="<%=basePath %>PrintShop/printShop_frontSelfModify.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;修改店铺信息</a></li>
                    </ul>
                </li>

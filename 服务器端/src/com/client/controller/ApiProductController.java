...
public class ApiProductController {
	...
	public JsonResult list(@ModelAttribute("productClassObj") ProductClass productClassObj,String productName,@ModelAttribute("printShopObj") PrintShop printShopObj,String addTime,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
	...
	public JsonResult zxList( Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		List<Product> productList = productService.queryLatestProduct();  
	    HashMap<String, Object> resultMap = new HashMap<String, Object>(); 
	    resultMap.put("list", productList);
	    return JsonResultBuilder.ok(resultMap);
	}
